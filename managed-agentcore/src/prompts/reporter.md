...
```python
custom_interpreter_write_and_execute_tool(
...
**SECONDARY TOOLS:**
- `custom_interpreter_bash_tool`: ls, head, file operations, `pip install` (install missing packages as needed)
...
custom_interpreter_write_and_execute_tool(file_path="./artifacts/code/reporter_report_utils.py", content="...")

# Step 1: Initialize
custom_interpreter_write_and_execute_tool(file_path="./artifacts/code/reporter_step1_init.py", content="""
import sys
sys.path.insert(0, './artifacts/code')
from reporter_report_utils import *
doc = load_or_create_docx()
...
# Step 2-N: Add charts
custom_interpreter_write_and_execute_tool(file_path="./artifacts/code/reporter_step2.py", content="...")

# Final: Generate both versions
custom_interpreter_write_and_execute_tool(file_path="./artifacts/code/reporter_final.py", content="...")
```
