...
def handle_tracker_agent_tool(completed_agent: Annotated[str, "The name of the agent that just completed its task"],
    ...
    with tracer.start_as_current_span("tracker_agent_tool") as span:
        ...
        # Add Event
        add_span_event(span, "input_message", {"completed_agent": completed_agent, "summary": completion_summary})
